...
values
	...
	('BUILDING_HD_CINEMA',										'YIELD_CULTURE',		5);
...
update Building_GreatPersonPoints set PointsPerTurn = 2 where GreatPersonClassType = 'GREAT_PERSON_CLASS_MUSICIAN' and BuildingType = 'BUILDING_BROADCAST_CENTER';
...
values
	('BUILDING_JNR_ASSEMBLY',									'GREAT_PERSON_CLASS_WRITER',		2),
	...
	('BUILDING_HD_CINEMA',										'GREAT_PERSON_CLASS_WRITER',		2),
	('BUILDING_HD_CINEMA',										'GREAT_PERSON_CLASS_ARTIST',		2),
...
values
	('BUILDING_JNR_ASSEMBLY',								'GREATWORKSLOT_PALACE',				1),
	...
	('BUILDING_HD_CINEMA',									'GREATWORKSLOT_WRITING',			2),
	('BUILDING_HD_CINEMA',									'GREATWORKSLOT_ART',					2);
...
values
	...
	-- ('BUILDING_HD_ART_PUBLISHING_HOUSE',	'GREATWORKSLOT_ART',				3,					1,											1,									100,											100,												'LOC_BUILDING_HD_ART_PUBLISHING_HOUSE_THEMINGBONUS'),
	('BUILDING_FILM_STUDIO',							'GREATWORKSLOT_PALACE',			3,					0,											1,									100,											100,												'LOC_BUILDING_HD_FILM_STUDIO_THEMINGBONUS');
...
values
	...
	('BUILDING_HD_CINEMA',								'YIELD_CULTURE',				1),
	...
	('BUILDING_HD_CINEMA',								'YIELD_GOLD',						-1);
...
values
	...
	-- 电影院
	('BUILDING_HD_CINEMA',					'BROADCAST_CENTER_CULTURE_PERCENTAGE_BOOST'),
	('BUILDING_HD_CINEMA',					'POWERED_BROADCAST_CENTER_CULTURE_PERCENTAGE_BOOST'),
	('BUILDING_HD_CINEMA',					'HD_CINEMA_GREATWORKOBJECT_WRITING_TOURISM'),
	('BUILDING_HD_CINEMA',					'HD_CINEMA_GREATWORKOBJECT_SCULPTURE_TOURISM'),
	('BUILDING_HD_CINEMA',					'HD_CINEMA_GREATWORKOBJECT_PORTRAIT_TOURISM'),
	('BUILDING_HD_CINEMA',					'HD_CINEMA_GREATWORKOBJECT_LANDSCAPE_TOURISM'),
	('BUILDING_HD_CINEMA',					'HD_CINEMA_GREATWORKOBJECT_RELIGIOUS_TOURISM'),
	('BUILDING_HD_CINEMA',					'HD_CINEMA_DISTRICT_CULTURE'),
	-- 广播中心
...
values
    ...
    ('HD_CITY_HAS_CULTURAL_TIER_4_BUILDING_REQUIREMENTS',       	'REQUIRES_CITY_HAS_BUILDING_HD_CINEMA'),
...
values
	...
	('HD_BUILDING_IS_TIER3_OR_OPERA_OR_HOTEL',		'REQUIRES_CITY_HAS_BUILDING_HD_CINEMA');
