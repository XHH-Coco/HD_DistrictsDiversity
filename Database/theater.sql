...
values
	...
	('BUILDING_JNR_CABINET',								'GREATWORKSLOT_ART',					1),
	('BUILDING_JNR_CABINET',								'GREATWORKSLOT_PALACE',				1),
...
values
	...
	-- 陈列室
	('BUILDING_JNR_CABINET',			'HD_CABINET_DISTRICT_CULTURE'),
	-- 歌剧院
...
values
	...
	-- 陈列室
	('HD_CABINET_DISTRICT_CULTURE',			'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',							'DISTRICT_IS_SPECIALTY_DISTRICT_REQUIREMENTS'),
	-- 歌剧院
...
values
	...
	-- 陈列室
	('HD_CABINET_DISTRICT_CULTURE',			'YieldType',				'YIELD_CULTURE'),
	('HD_CABINET_DISTRICT_CULTURE',			'Amount',					2),
	-- 歌剧院
...
values
	...
	('POLICY_HD_FASHIONABLE_DISTRICT',		'HD_FASHIONABLE_DISTRICT_GREAT_WRITER_THEATER_5'),
	('POLICY_HD_FASHIONABLE_DISTRICT',		'HD_FASHIONABLE_DISTRICT_GREAT_ARTIST_THEATER_5'),
	('POLICY_HD_FASHIONABLE_DISTRICT',		'HD_FASHIONABLE_DISTRICT_GREAT_MUSICIAN_THEATER_5');
...
values
	...
	('HD_FASHIONABLE_DISTRICT_GREAT_WRITER_THEATER_5',					'MODIFIER_PLAYER_DISTRICTS_ADJUST_GREAT_PERSON_POINTS',						'HD_FASHIONABLE_DISTRICT_THEATER_4_REQUIREMENTS'),
	('HD_FASHIONABLE_DISTRICT_GREAT_ARTIST_THEATER_5',					'MODIFIER_PLAYER_DISTRICTS_ADJUST_GREAT_PERSON_POINTS',						'HD_FASHIONABLE_DISTRICT_THEATER_4_REQUIREMENTS'),
	('HD_FASHIONABLE_DISTRICT_GREAT_MUSICIAN_THEATER_5',				'MODIFIER_PLAYER_DISTRICTS_ADJUST_GREAT_PERSON_POINTS',						'HD_FASHIONABLE_DISTRICT_THEATER_4_REQUIREMENTS');
...
values
	...
	('HD_FASHIONABLE_DISTRICT_THEATER_4_REQUIREMENTS',		'REQUIREMENTSET_TEST_ALL');
...
values
	...
	('HD_FASHIONABLE_DISTRICT_THEATER_4_REQUIREMENTS',	'REQUIRES_PLOT_HAS_DISTRICT_THEATER_TIER_4_BUILDING'),
...
update Civics set Cost = 180 where Cost = 180;
