...
values
	...
	('BUILDING_JNR_WHARF_FISHING',		'KIND_BUILDING'),--渔业港市
	('BUILDING_JNR_WHARF_TRADE',		'KIND_BUILDING'),--贸易港市
	-- 港口
...
values
	...
	('BUILDING_JNR_WAYSTATION',			'DISTRICT_COMMERCIAL_HUB',	'TECH_HORSEBACK_RIDING',		NULL,						110,   0,		1,				1,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_WAYSTATION_NAME',			'LOC_BUILDING_JNR_WAYSTATION_DESCRIPTION'),
	...
	-- 市中心
	('BUILDING_JNR_DUMMY_CITY_COASTAL',	NULL,						NULL,							NULL,						1,	   0,		0,				Null,			Null,			'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_DUMMY_CITY_COASTAL_NAME',	'LOC_BUILDING_JNR_DUMMY_CITY_COASTAL_DESCRIPTION'),
	('BUILDING_JNR_WHARF_BASE',			NULL,						NULL,							NULL,						1,	   0,		0,				Null,			Null,			'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_WHARF_BASE_NAME',			'LOC_BUILDING_JNR_WHARF_BASE_DESCRIPTION'),
	('BUILDING_JNR_WHARF_FISHING',		'DISTRICT_CITY_CENTER',		'TECH_SAILING',					NULL,						50,	   1,		0,				0,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_WHARF_FISHING_NAME',		'LOC_BUILDING_JNR_WHARF_FISHING_DESCRIPTION'),
	('BUILDING_JNR_WHARF_TRADE',		'DISTRICT_CITY_CENTER',		'TECH_SAILING',					NULL,						50,	   1,		0,				0,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_WHARF_TRADE_NAME',		'LOC_BUILDING_JNR_WHARF_TRADE_DESCRIPTION'),
	-- 港口
...
insert or replace into HD_DUMMY_BUILDINGS (BuildingType) values ('BUILDING_JNR_WHARF_BASE');
--------------------------------------------------------------
...
-- delete from BuildingReplaces where CivUniqueBuildingType = 'BUILDING_SUKIENNICE' and not
-- 	exists (select BuildingType from Buildings where BuildingType = 'BUILDING_SUKIENNICE');
...
values
	('BUILDING_JNR_WHARF_BASE',			'BUILDING_JNR_DUMMY_CITY_COASTAL'),
...
insert or ignore into MutuallyExclusiveBuildings (Building, MutuallyExclusiveBuilding)
	select 'BUILDING_JNR_WAYSTATION', 'BUILDING_SUKIENNICE'
	where exists (select BuildingType from Buildings where BuildingType = 'BUILDING_SUKIENNICE');
...
insert or ignore into MutuallyExclusiveBuildings (Building, MutuallyExclusiveBuilding)
	select 'BUILDING_SUKIENNICE', 'BUILDING_JNR_WAYSTATION'
	where exists (select BuildingType from Buildings where BuildingType = 'BUILDING_SUKIENNICE');
