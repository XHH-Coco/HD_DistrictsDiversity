...
VALUES	('BUILDING_JNR_ALTAR',		'DISTRICT_HOLY_SITE',	'CIVIC_MYSTICISM',			70,		1,				1,				0,			0,				4,				'YIELD_GOLD',	'ADVISOR_RELIGIOUS',	'LOC_BUILDING_JNR_ALTAR_NAME',		'LOC_BUILDING_JNR_ALTAR_DESCRIPTION'),
		...
		('BUILDING_JNR_HOSPITIUM',	'DISTRICT_HOLY_SITE',	'CIVIC_REFORMED_CHURCH',	240,	4,				2,				1,			1,				6,				'YIELD_FAITH',	'ADVISOR_RELIGIOUS',	'LOC_BUILDING_JNR_HOSPITIUM_NAME',	'LOC_BUILDING_JNR_HOSPITIUM_DESCRIPTION'),
		('BUILDING_JNR_GARDEN',		'DISTRICT_HOLY_SITE',	'CIVIC_HUMANISM',						240,	4,				0,				1,			0,				0,				'YIELD_FAITH',	'ADVISOR_RELIGIOUS',	'LOC_BUILDING_JNR_GARDEN_NAME',		'LOC_BUILDING_JNR_GARDEN_DESCRIPTION');
