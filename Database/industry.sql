...
values
    ('WATER_MILL_RIVER_DISTRICTS_PRODUCTION',           'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',          'PLOT_IS_ADJACENT_TO_RIVER'),
    ('WIND_MILL_DISTRICTS_PRODUCTION',                  'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',          'HD_WIND_MILL_REQUIREMENTS'),
