...
values
    ...
    ('HD_CITY_HAS_SCIENTIFIC_TIER_4_BUILDING_REQUIREMENTS',     'REQUIRES_CITY_HAS_BUILDING_HD_AGRICULTURE_COLLEGE'),
    ('HD_CITY_HAS_SCIENTIFIC_TIER_4_BUILDING_REQUIREMENTS',     'REQUIRES_CITY_HAS_BUILDING_HD_FINANCE_COLLEGE');
...
values
    ...
    ('REAL_ACADEMY_CHEMISTRY_DISTRICT_ADJACENCY',   'MODIFIER_SINGLE_CITY_DISTRICT_ADJUST_YIELD_MODIFIER',      'PLAYER_HAS_TECH_BIOLOGY_HD_REQUIREMENTS'),
