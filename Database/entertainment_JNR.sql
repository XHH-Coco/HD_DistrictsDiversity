...
values	('BUILDING_JNR_TOURNEY',			'DISTRICT_ENTERTAINMENT_COMPLEX',		'CIVIC_DRAMA_POETRY',		Null,							160,	1,				Null,			1,				0,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_TOURNEY_NAME',			'LOC_BUILDING_JNR_TOURNEY_DESCRIPTION'),
		('BUILDING_JNR_BOTANICAL_GARDEN',	'DISTRICT_ENTERTAINMENT_COMPLEX',		'CIVIC_COMMERCIAL_CAPITALISM_HD',			Null,							360,	4,				Null,			2,				0,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_BOTANICAL_GARDEN_NAME',	'LOC_BUILDING_JNR_BOTANICAL_GARDEN_DESCRIPTION'),
