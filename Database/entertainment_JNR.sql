...
values	('BUILDING_JNR_TOURNEY',			'DISTRICT_ENTERTAINMENT_COMPLEX',		'CIVIC_DRAMA_POETRY',		Null,							160,	1,				Null,			1,				0,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_TOURNEY_NAME',			'LOC_BUILDING_JNR_TOURNEY_DESCRIPTION'),
		('BUILDING_JNR_BOTANICAL_GARDEN',	'DISTRICT_ENTERTAINMENT_COMPLEX',		'CIVIC_HUMANISM',			Null,							360,	4,				Null,			2,				0,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_BOTANICAL_GARDEN_NAME',	'LOC_BUILDING_JNR_BOTANICAL_GARDEN_DESCRIPTION'),
		...
		('BUILDING_JNR_CASINO',				'DISTRICT_WATER_ENTERTAINMENT_COMPLEX',	Null,						'TECH_FLIGHT',					360,	4,				Null,			2,				0,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_CASINO_NAME',				'LOC_BUILDING_JNR_CASINO_DESCRIPTION'),
...
values	('BUILDING_JNR_BOTANICAL_GARDEN',	'BUILDING_ARENA'),
		...
		('BUILDING_JNR_THEME_PARK',			'BUILDING_HD_CIRCUS'),
		('BUILDING_JNR_THEME_PARK',			'BUILDING_HD_JEWELRY_SHOP'),
...
values	('BUILDING_ARENA',					'BUILDING_JNR_TOURNEY'),
		...
		('BUILDING_HD_CIRCUS',					'BUILDING_JNR_BOTANICAL_GARDEN'),
		('BUILDING_HD_JEWELRY_SHOP',					'BUILDING_JNR_BOTANICAL_GARDEN'),

		('BUILDING_JNR_BOTANICAL_GARDEN',	'BUILDING_ZOO'),
		('BUILDING_JNR_BOTANICAL_GARDEN',	'BUILDING_HD_CIRCUS'),
		('BUILDING_JNR_BOTANICAL_GARDEN',	'BUILDING_HD_JEWELRY_SHOP'),
