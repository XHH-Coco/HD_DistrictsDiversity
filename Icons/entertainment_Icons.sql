...
VALUES  ('ICON_BUILDING_ARENA',                     'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',                  0),
        ...
        ('ICON_BUILDING_ARENA_FOW',                     'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',                  0),
        ('ICON_BUILDING_JNR_TOURNEY_FOW',               'ICON_ATLAS_BUILDINGS',                             8),
        ('ICON_BUILDING_JNR_BOTANICAL_GARDEN_FOW',      'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',                  1),
        ('ICON_BUILDING_JNR_THEME_PARK_FOW',            'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',                  2),
        ('ICON_BUILDING_JNR_MARINA_FOW',                'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',                  3),
        ('ICON_BUILDING_JNR_CASINO_FOW',                'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',                  4),
        ('ICON_BUILDING_JNR_FOOD_COURT_FOW',            'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',                  5);
