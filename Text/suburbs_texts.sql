...
values
    ...
    ("LOC_BUILDING_JNR_RECYCLING_PLANT_DESCRIPTION",                "+1 Appealing to tiles in this city. For each type of Medicine Resource you controlled, +2% accumulation rate for [ICON_GREATENGINEER] Great Engineer Points. [NEWLINE][NEWLINE]Undamaged military units can be recycled in this city: land units on Neighborhood district; naval units on Harbor district; air units on Aerodrome district. [NEWLINE]Weapon Recycling {LOC_HD_RECYCLE_FORMULA} [NEWLINE][NEWLINE]Can only be built once in a civilization."),
    ...
    ("LOC_BUILDING_JNR_ART_GALLERY_DESCRIPTION",                    "For each type of Art Resource you controlled, +2% accumulation rate for Cultural [ICON_GREATPERSON] Great Person points. +20% [ICON_CULTURE] Culture and +200% [ICON_TOURISM] Tourism to Cultural Great Work if the city is [ICON_POWER] powered. [NEWLINE][NEWLINE]Can only be built once in a civilization."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_HOSPITAL_DESCRIPTION",                    "您位于或相邻中心医院的单位每回合额外回复20生命值。你每拥有一种医药资源，[ICON_GREATSCIENTIST] 大科学家点数积累速度+2%。[NEWLINE][NEWLINE]你的城市有概率避免损失 [ICON_CITIZEN] 市民；当 [ICON_CITIZEN] 市民增长时，有概率额外获得一个 [ICON_CITIZEN] 市民。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_ART_GALLERY_DESCRIPTION",                 "你每拥有一种艺术资源，文化类 [ICON_GREATPERSON] 伟人点数积累速度+2%。若此城 [ICON_POWER] 供电充足，境内的文化类巨作提供1.2倍的 [ICON_CULTURE] 文化产出，且 [ICON_TOURISM] 旅游业绩+200%。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
