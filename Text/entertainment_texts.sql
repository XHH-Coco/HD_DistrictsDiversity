...
values
    ...
    ("LOC_BUILDING_ZOO_DESCRIPTION_UC_JNR",                      "+1 [ICON_Food] Food, +1 [ICON_Culture] Culture and +3 [ICON_Gold] Gold from every type of improved Camp or Pasture Resource within your empire. +6 [ICON_Gold] Gold to Camps and Pastures in this city; doubled after Biology is researched."),
    ("LOC_BUILDING_JNR_BOTANICAL_GARDEN_NAME",                   "Botanical Garden"),
    ("LOC_BUILDING_JNR_BOTANICAL_GARDEN_DESCRIPTION",            "+1 [ICON_PRODUCTION] Production, +1 [ICON_SCIENCE] Science and +3 [ICON_Gold] Gold from every type of improved Plantation, Farm or Lumber Mill Resource within your empire. +6 [ICON_Gold] Gold to Plantations, Farms and Lumber Mills in this city; doubled after Biology is researched."),
    ...
    ("LOC_BUILDING_AQUARIUM_DESCRIPTION_UC_JNR",                 "+1 [ICON_Food] Food, +1 [ICON_SCIENCE] Science and +3 [ICON_Gold] Gold from every type of improved Fishing Boat Resource within your empire. +6 [ICON_Gold] Gold to Fishing Boats and Fisheries in this city; doubled after Biology is researched."),
    ("LOC_BUILDING_JNR_CASINO_NAME",                             "Visitor Center"),
    ("LOC_BUILDING_JNR_CASINO_DESCRIPTION",                      "Wonders in this City provide +2 [ICON_CULTURE] Culture and +6 [ICON_Gold] Gold. Each Commercial Hub, Harbour and Aerodrome provide +50% [ICON_TOURISM] Tourism to Wonders in this City."),
    ("LOC_BUILDING_JNR_CASINO_DESCRIPTION_STATION",              "Wonders in this City provide +2 [ICON_CULTURE] Culture and +6 [ICON_Gold] Gold. Each Commercial Hub, Harbour, Aerodrome and Station provide +50% [ICON_TOURISM] Tourism to Wonders in this City."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_ZOO_DESCRIPTION_UC_JNR",                      "境内每拥有一种改良的牧场或营地资源，动物园额外+1 [ICON_FOOD] 食物，+1 [ICON_CULTURE] 文化值，+3 [ICON_GOLD] 金币。此城的牧场和营地+6 [ICON_Gold] 金币，解锁“生物”科技后收益翻倍。"),
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_BOTANICAL_GARDEN_NAME",                   "植物园"),
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_BOTANICAL_GARDEN_DESCRIPTION",            "境内每拥有一种改良的农场、种植园或伐木场资源，植物园额外+1 [ICON_PRODUCTION] 生产力，+1 [ICON_SCIENCE] 科技值，+3 [ICON_GOLD] 金币。此城的农场、种植园和伐木场+6 [ICON_Gold] 金币，解锁“生物”科技后收益翻倍。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_AQUARIUM_DESCRIPTION_UC_JNR",                 "境内每拥有一种改良的渔船资源，水族馆额外+1 [ICON_FOOD] 食物，+1 [ICON_SCIENCE] 科技值，+3 [ICON_GOLD] 金币。此城的渔船和渔场+6 [ICON_Gold] 金币，解锁“生物”科技后收益翻倍。"),
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_CASINO_NAME",                             "游客接待中心"),
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_CASINO_DESCRIPTION",                      "城市中每座奇观+2 [ICON_CULTURE] 文化值和+6 [ICON_GOLD] 金币。城市中的每个商业中心、港口或航空港为本城奇观的 [ICON_Tourism] 旅游业绩+50%。"),
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_CASINO_DESCRIPTION_STATION",              "城市中每座奇观+2 [ICON_CULTURE] 文化值和+6 [ICON_GOLD] 金币。城市中的每个商业中心、港口、航空港或火车站为本城奇观的 [ICON_Tourism] 旅游业绩+50%。"),
