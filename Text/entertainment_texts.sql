...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_MARINA_DESCRIPTION",                      "城市中相邻或建在浅海或湖泊单元格之上或周围的每座区域、奇观每回合+2 [ICON_GREATMUSICIAN] 大音乐家点数。本城来自 [ICON_GreatWork_Music] 音乐巨作的 [ICON_TOURISM] 旅游业绩+50%。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FERRIS_WHEEL_DESCRIPTION_UC_JNR",             "城市中相邻或建在浅海或湖泊单元格之上或周围的每座区域、奇观和改良+3 [ICON_Gold] 金币。此城中海滨度假区的 [ICON_Tourism] 旅游业绩+50%。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_AQUATICS_CENTER_DESCRIPTION_UC_JNR",          "若此城 [ICON_POWER] 供电充足，则城市中每建有一种专业化区域，本城所有位于或与浅海湖泊单元格相邻的区域获得4份该专业化区域的对应产出。"),
