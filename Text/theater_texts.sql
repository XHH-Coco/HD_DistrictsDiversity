...
values
    ...
    ("LOC_BUILDING_JNR_CABINET_DESCRIPTION",                    "+1 [ICON_CULTURE] Culture from every type of Art or Decoration Resource you controlled. +2 [ICON_CULTURE] Culture for all Speciality District. +50% [ICON_TOURISM] Tourism for Great Works in this city."),
    -- 官学
    ...
    ("LOC_BUILDING_FILM_STUDIO_DESCRIPTION_UC_JNR",             "A building unique to America. +10% [ICON_CULTURE] Culture in this city. +10% [ICON_CULTURE] Culture if this city is fully powered. +3 [ICON_CULTURE] Culture for all districts in this city. +50% [ICON_Tourism] Tourism pressure from this city. +100% [ICON_TOURISM] Tourism for [ICON_GreatWork_Writing] Great Works of Writing, [ICON_GreatWork_LANDSCAPE] Great Works of Art and [ICON_GreatWork_Music] Great Works of Music in this city."),
    -- 尤里卡 鼓舞
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_CABINET_DESCRIPTION",                    "你每拥有一种艺术或饰品资源，+1 [ICON_CULTURE] 文化值。本城每个专业化区域+2 [ICON_CULTURE] 文化值。本城所有巨作+50% [ICON_TOURISM] 旅游业绩。"),
    -- 官学
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_FILM_STUDIO_DESCRIPTION_UC_JNR",             "美国特色建筑。本城+10% [ICON_CULTURE] 文化值，[ICON_POWER] 供电充足时额外+10% [ICON_CULTURE] 文化值。此城市的区域+3 [ICON_CULTURE] 文化值。本城+50% [ICON_TOURISM] 旅游业绩。本城中的 [ICON_GreatWork_Writing] 著作、[ICON_GreatWork_LANDSCAPE] 艺术和 [ICON_GreatWork_Music] 音乐巨作产出的 [ICON_TOURISM] 旅游业绩+100%。"),
    -- 尤里卡 鼓舞
