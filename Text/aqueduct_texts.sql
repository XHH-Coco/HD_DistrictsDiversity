...
values
    ...
    ("LOC_DISTRICT_AQUEDUCT_DESCRIPTION_JNR_UC",                "+1 [ICON_FOOD] Food. +1 [ICON_PRODUCTION] Production if adjacent to Mountain tiles. +1 [ICON_SCIENCE] Science if on or adjacent to Geothermal Fissure tiles. [NEWLINE]A district that provides this city with a source of fresh water from an adjacent River, Lake, Oasis, or Mountain. Cities that do not yet have existing fresh water change its [ICON_Housing] Housing from water to 6. Cities that already have existing fresh water will instead get +2 [ICON_Housing] Housing. Prevents [ICON_Food] Food loss during Drought. [NEWLINE]Must be built adjacent to the City Center. Military Engineers can spend a charge to complete 30% of a Cistern's production. One per city."),
    ("LOC_DISTRICT_BATH_NAME_JNR_UC",                           "Aqueduct"),
    ("LOC_DISTRICT_BATH_DESCRIPTION_JNR_UC",                    "A district unique to Rome for city growth. Replaces the Cistern district and cheaper to build. [NEWLINE]+1 [ICON_FOOD] Food, +2 [ICON_Housing] Housing and +1 [ICON_Amenities] Amenity. +1 [ICON_PRODUCTION] Production if adjacent to Mountain tiles. +1 [ICON_SCIENCE] Science if on or adjacent to Geothermal Fissure tiles. +100% construction speed for buildings inside Aqueduct. [NEWLINE]Provides this city with a source of fresh water from an adjacent River, Lake, Oasis, or Mountain. Cities that do not yet have existing fresh water change its [ICON_Housing] Housing from water to 6. Cities that already have existing fresh water will instead get +2 [ICON_Housing] Housing. Prevents [ICON_Food] Food loss during Drought. [NEWLINE]Must be built adjacent to the City Center. Military Engineers can spend a charge to complete 30% of an Aqueduct's production. One per city."),
    -- 
