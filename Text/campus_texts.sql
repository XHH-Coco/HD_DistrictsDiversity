...
VALUES  ('LOC_BUILDING_JNR_ACADEMY_NAME',                           'Sishu'),
        ...
        ('LOC_BUILDING_JNR_REAL_ACADEMY_DESCRIPTION',               'This Campus receives [ICON_Science] Science equal to its adjacency bonus. +100% Adjacency of this Campus after completing Biology.'),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_REAL_ACADEMY_DESCRIPTION",                "此学院获得等于相邻加成的 [ICON_Science] 科技值加成。解锁“生物”科技后，此学院+100%相邻加成。"),
